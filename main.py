...
st.write("Upload a file and split it into multiple batches based on number of rows with custom date formatting.")
...
if uploaded_file is not None and rows_per_batch:
    ...
    # 🔄 Auto-detect and convert date columns to datetime objects 
    # This ensures Pandas knows which columns to apply the format to
    ...
    if st.button("🚀 Split File"):
        ...
        with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            for i in range(total_batches):
                ...
                # 🛠️ Set the date format via ExcelWriter
